...
```yml
flink-master:
   image: bde2020/flink-master:1.13.0-hadoop3.2
 ...
 flink-worker:
   image: bde2020/flink-worker:1.13.0-hadoop3.2
...
To start a Flink master:
    ...
    docker run --name flink-master --net flink-net -d bde2020/flink-master:1.13.0-hadoop3.2

## Flink Worker
To start a Flink worker:

    docker run --name flink-worker --net flink-net -e FLINK_MASTER_PORT_6123_TCP_ADDR=flink-master -d bde2020/flink-worker:1.13.0-hadoop3.2
